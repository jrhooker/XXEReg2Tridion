...
<!ENTITY % ish-managment-atts
                         'srclang NMTOKEN #IMPLIED
                          version NMTOKEN #IMPLIED'
>
<!-- lang NMTOKEN #IMPLIED - included by ish-transl-attr -->
...
<!ENTITY % ish-transl-atts
                         'chg ( non | new | upd | del | undef )  "undef"
...
><!-- FC include-domains caused problems in .NET -->
