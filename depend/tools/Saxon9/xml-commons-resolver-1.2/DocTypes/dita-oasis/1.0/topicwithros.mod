...
PUBLIC "-//Trisoft//ELEMENTS DITA TopicWithROs//EN"
      Delivered as file "topicwithros.mod"                         -->
...
<!ENTITY % id-atts  
            'id         NMTOKEN                            #IMPLIED
             ...
             ishlabelxpath CDATA #FIXED "./title | @alt | @href | @conref | @id"
...
FC Problem with default namespace and MSXML
For more info: http://support.microsoft.com/default.aspx?scid=KB;EN-US;Q296492&ID=KB;EN-US;Q296492
...
<!ATTLIST xref            
             ...
             outputclass 
                        CDATA                            #IMPLIED    
             ishhyperlinkxpath CDATA #FIXED "@href[./@format='dita'] | @href[not(@format)]">
