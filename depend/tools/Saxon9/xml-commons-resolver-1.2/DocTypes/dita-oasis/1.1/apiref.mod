...
<!ENTITY % paramDateOut           "paramDateOut"                          >
...
<!ELEMENT paramDateIn         (%paramName;, %paramDesc;)                           >
<!ATTLIST paramDateIn       
             %univ-atts;
             ishlabelxpath CDATA #FIXED "./title | @alt | @href | @conref | self::*[@id and not(@varid)]/@id"
             ishlinkxpath CDATA #FIXED "@conref | @href[contains(parent::*/@class,&apos; topic/image &apos;) and not(parent::*/@conref)]"
...
<!ELEMENT paramDateOut         (%paramName;, %paramDesc;)                           >
<!ATTLIST paramDateOut       
             %univ-atts;
             ishlabelxpath CDATA #FIXED "./title | @alt | @href | @conref | self::*[@id and not(@varid)]/@id"
             ishlinkxpath CDATA #FIXED "@conref | @href[contains(parent::*/@class,&apos; topic/image &apos;) and not(parent::*/@conref)]"
             outputclass 
