...
<!ENTITY % ish-anchor-atts
           "ishtype       CDATA #FIXED 'ISHSection'
            ishlabelxpath CDATA #FIXED 'concat(string(&apos;Anchor: &apos;), @id)'">

<!ENTITY % ish-navref-atts
           "ishtype       CDATA #FIXED 'ISHSection'
            ishlinkxpath  CDATA #FIXED '@mapref[not(ancestor::*[@scope and @scope!=&apos;&apos;][position()=1]/@scope=&apos;external&apos;)]'
            ishlabelxpath CDATA #FIXED '@mapref[ancestor::*[@scope and @scope!=&apos;&apos;][position()=1]/@scope=&apos;external&apos;]'">

<!ENTITY % ish-topicref-atts
           "ishtype       CDATA #FIXED 'ISHSection'
            %ishlinkxpath-section-default;
            %ishlabelxpath-section-default;">

<!ENTITY % ish-topicmeta-atts
           "%ishlabelxpath-general-default;
            %ishlinkxpath-general-default;">

<!ENTITY % ish-linktext-atts
           "%ishlabelxpath-general-default;
            %ishlinkxpath-general-default;">

<!ENTITY % ish-searchtitle-atts
           "%ishlabelxpath-general-default;
            %ishlinkxpath-general-default;">

<!ENTITY % ish-reltable-atts
           "ishtype      CDATA #FIXED 'ISHSection'
            ishlabelxpath CDATA   #FIXED   'concat(string(&apos;Relationship Table &apos;), @title)'
            %ishlinkxpath-general-default;">

<!ENTITY % ish-relheader-atts
           "ishtype      CDATA #FIXED 'ISHSection'
            ishlabelxpath CDATA   #FIXED   'string(&apos;Relationship Column Specification&apos;)'
            %ishlinkxpath-general-default;">

<!ENTITY % ish-relcolumn-atts
           "ishtype      CDATA #FIXED 'ISHSection'
            ishlabelxpath CDATA   #FIXED   'concat(string(&apos;Column &apos;), @type)'
            %ishlinkxpath-general-default;">

<!ENTITY % ish-relrow-atts
           "ishtype      CDATA #FIXED 'ISHSection'
            ishlabelxpath CDATA   #FIXED   'string(&apos;Relation&apos;)'
            %ishlinkxpath-general-default;">

<!ENTITY % ish-relcell-atts
           "ishtype      CDATA #FIXED 'ISHSection'
            ishlabelxpath CDATA   #FIXED  'concat(string(&apos;Relation &apos;), self::*[count(preceding-sibling::*)+1=1]/../../relheader/relcolspec[1]/@type |  self::*[count(preceding-sibling::*)+1=2]/../../relheader/relcolspec[2]/@type |  self::*[count(preceding-sibling::*)+1=3]/../../relheader/relcolspec[3]/@type |  self::*[count(preceding-sibling::*)+1=4]/../../relheader/relcolspec[4]/@type |  self::*[count(preceding-sibling::*)+1=5]/../../relheader/relcolspec[5]/@type |  self::*[count(preceding-sibling::*)+1=6]/../../relheader/relcolspec[6]/@type |  self::*[count(preceding-sibling::*)+1=7]/../../relheader/relcolspec[7]/@type |  self::*[count(preceding-sibling::*)+1=8]/../../relheader/relcolspec[8]/@type |  ../../relheader/relcolspec[9]/@type | self::*[count(preceding-sibling::*)+1=1]/../../relheader/relcolspec[1]/@linking |  self::*[count(preceding-sibling::*)+1=2]/../../relheader/relcolspec[2]/@linking |  self::*[count(preceding-sibling::*)+1=3]/../../relheader/relcolspec[3]/@linking |  self::*[count(preceding-sibling::*)+1=4]/../../relheader/relcolspec[4]/@linking |  self::*[count(preceding-sibling::*)+1=5]/../../relheader/relcolspec[5]/@linking |  self::*[count(preceding-sibling::*)+1=6]/../../relheader/relcolspec[6]/@linking |  self::*[count(preceding-sibling::*)+1=7]/../../relheader/relcolspec[7]/@linking |  self::*[count(preceding-sibling::*)+1=8]/../../relheader/relcolspec[8]/@linking |  ../../relheader/relcolspec[9]/@linking)'
            %ishlinkxpath-section-default; ">
