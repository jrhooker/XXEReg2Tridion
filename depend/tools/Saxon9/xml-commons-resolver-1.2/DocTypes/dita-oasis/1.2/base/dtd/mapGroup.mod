...
<!ENTITY % ish-topichead-atts
              "ishtype       CDATA   #FIXED   'ISHSection'
              %ishlabelxpath-section-default;
              %ishlinkxpath-section-default;">
<!ENTITY % ish-topicgroup-atts
              "ishtype       CDATA   #FIXED   'ISHSection'
               ishlabelxpath CDATA   #FIXED   'concat(string(&apos;Topic Group &apos;), self::*[@id and not(@varid)]/@id)'
              %ishlinkxpath-section-default;">
<!ENTITY % ish-anchorref-atts
              "ishtype       CDATA   #FIXED   'ISHSection'
               ishlabelxpath CDATA   #FIXED   'concat(string(&apos;Anchor Ref: &apos;), substring-after(@href, &apos;#&apos;))'
              %ishlinkxpath-section-default;">
<!ENTITY % ish-mapref-atts
              "ishtype       CDATA   #FIXED   'ISHSection'
              %ishlabelxpath-section-default;
              %ishlinkxpath-section-default;">
<!ENTITY % ish-topicset-atts
              "ishtype       CDATA   #FIXED   'ISHSection'
              %ishlabelxpath-section-default;
              %ishlinkxpath-section-default;">
<!ENTITY % ish-topicsetref-atts
              "ishtype       CDATA   #FIXED   'ISHSection'
              %ishlabelxpath-section-default;
              %ishlinkxpath-section-default;">
<!ENTITY % ish-keydef-atts
              "ishtype       CDATA   #FIXED   'ISHSection'
              %ishlabelxpath-section-default;
              %ishlinkxpath-section-default;">
