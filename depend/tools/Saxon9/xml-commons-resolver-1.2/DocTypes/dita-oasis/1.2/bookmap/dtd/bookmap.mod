...
<!ENTITY % ish-bookmap-atts     
           "%ish-map-atts;">

<!ENTITY % ish-bookmeta-atts
           "ishtype       CDATA #FIXED   'ISHSection'
            ishlabelxpath CDATA #FIXED   'string(&apos;Book Metadata&apos;)'
            %ishlinkxpath-general-default;">

<!ENTITY % ish-frontmatter-atts
           "ishtype       CDATA #FIXED   'ISHSection'
            ishlabelxpath CDATA #FIXED   'string(&apos;Front Matter&apos;)'
            %ishlinkxpath-section-default;">

<!ENTITY % ish-backmatter-atts
           "ishtype       CDATA #FIXED   'ISHSection'
            ishlabelxpath CDATA #FIXED   'string(&apos;Back Matter&apos;)'
            %ishlinkxpath-section-default;">

<!ENTITY % ish-draftintro-atts
           "ishtype       CDATA #FIXED   'ISHSection'
            ishlabelxpath CDATA #FIXED   'concat(string(&apos;Draft Introduction &apos;), ./topicmeta/navtitle, @navtitle[not(parent::*/topicmeta/navtitle)])'
            %ishlinkxpath-section-default;">

<!ENTITY % ish-bookabstract-atts
           "ishtype       CDATA #FIXED   'ISHSection'
            ishlabelxpath CDATA #FIXED   'concat(string(&apos;Book Abstract &apos;), ./topicmeta/navtitle, @navtitle[not(parent::*/topicmeta/navtitle)])'
            %ishlinkxpath-section-default;">

<!ENTITY % ish-dedication-atts
           "ishtype       CDATA #FIXED   'ISHSection'
            ishlabelxpath CDATA #FIXED   'concat(string(&apos;Dedication &apos;), ./topicmeta/navtitle, @navtitle[not(parent::*/topicmeta/navtitle)])'
            %ishlinkxpath-section-default;">
<!ENTITY % ish-preface-atts
           "ishtype       CDATA #FIXED   'ISHSection'
            ishlabelxpath CDATA #FIXED   'concat(string(&apos;Preface &apos;), ./topicmeta/navtitle, @navtitle[not(parent::*/topicmeta/navtitle)])'
            %ishlinkxpath-section-default;">

<!ENTITY % ish-chapter-atts
           "ishtype       CDATA #FIXED   'ISHSection'
            ishlabelxpath CDATA #FIXED   'concat(string(&apos;Chapter &apos;), ./topicmeta/navtitle, @navtitle[not(parent::*/topicmeta/navtitle)])'
            %ishlinkxpath-section-default;">

<!ENTITY % ish-part-atts
           "ishtype       CDATA #FIXED   'ISHSection'
            ishlabelxpath CDATA #FIXED   'concat(string(&apos;Part &apos;), ./topicmeta/navtitle, @navtitle[not(parent::*/topicmeta/navtitle)])'
            %ishlinkxpath-section-default;">

<!ENTITY % ish-appendix-atts
           "ishtype       CDATA #FIXED   'ISHSection'
            ishlabelxpath CDATA #FIXED   'concat(string(&apos;Appendix &apos;), ./topicmeta/navtitle, @navtitle[not(parent::*/topicmeta/navtitle)])'
            %ishlinkxpath-section-default;">

<!ENTITY % ish-appendices-atts
           "ishtype       CDATA #FIXED   'ISHSection'
            ishlabelxpath CDATA #FIXED   'concat(string(&apos;Appendices &apos;), ./topicmeta/navtitle, @navtitle[not(parent::*/topicmeta/navtitle)])'
            %ishlinkxpath-section-default;">

<!ENTITY % ish-notices-atts
           "ishtype       CDATA #FIXED   'ISHSection'
            ishlabelxpath CDATA #FIXED   'concat(string(&apos;Notices &apos;), ./topicmeta/navtitle, @navtitle[not(parent::*/topicmeta/navtitle)])'
            %ishlinkxpath-section-default;">

<!ENTITY % ish-amendments-atts
           "ishtype       CDATA #FIXED   'ISHSection'
            ishlabelxpath CDATA #FIXED   'concat(string(&apos;Amendments &apos;), ./topicmeta/navtitle, @navtitle[not(parent::*/topicmeta/navtitle)])'
            %ishlinkxpath-section-default;">

<!ENTITY % ish-colophon-atts
           "ishtype       CDATA #FIXED   'ISHSection'
            ishlabelxpath CDATA #FIXED   'concat(string(&apos;Colophon &apos;), ./topicmeta/navtitle, @navtitle[not(parent::*/topicmeta/navtitle)])'
            %ishlinkxpath-section-default;">

<!ENTITY % ish-booklists-atts
           "ishtype       CDATA #FIXED   'ISHSection'
            ishlabelxpath CDATA #FIXED   'string(&apos;Book Lists&apos;)'
            %ishlinkxpath-section-default;">

<!ENTITY % ish-toc-atts
           "ishtype       CDATA #FIXED   'ISHSection'
            ishlabelxpath CDATA #FIXED   'concat(string(&apos;Table of Contents &apos;), ./topicmeta/navtitle, @navtitle[not(parent::*/topicmeta/navtitle)])'
            %ishlinkxpath-section-default;">

<!ENTITY % ish-figurelist-atts
           "ishtype       CDATA #FIXED   'ISHSection'
            ishlabelxpath CDATA #FIXED   'concat(string(&apos;Figure List &apos;), ./topicmeta/navtitle, @navtitle[not(parent::*/topicmeta/navtitle)])'
            %ishlinkxpath-section-default;">

<!ENTITY % ish-tablelist-atts
           "ishtype       CDATA #FIXED   'ISHSection'
            ishlabelxpath CDATA #FIXED   'concat(string(&apos;Table List &apos;), ./topicmeta/navtitle, @navtitle[not(parent::*/topicmeta/navtitle)])'
            %ishlinkxpath-section-default;">

<!ENTITY % ish-abbrevlist-atts
           "ishtype       CDATA #FIXED   'ISHSection'
            ishlabelxpath CDATA #FIXED   'concat(string(&apos;Abbreviation List &apos;), ./topicmeta/navtitle, @navtitle[not(parent::*/topicmeta/navtitle)])'
            %ishlinkxpath-section-default;">

<!ENTITY % ish-trademarklist-atts
           "ishtype       CDATA #FIXED   'ISHSection'
            ishlabelxpath CDATA #FIXED   'concat(string(&apos;Trademark List &apos;), ./topicmeta/navtitle, @navtitle[not(parent::*/topicmeta/navtitle)])'
            %ishlinkxpath-section-default;">

<!ENTITY % ish-bibliolist-atts
           "ishtype       CDATA #FIXED   'ISHSection'
            ishlabelxpath CDATA #FIXED   'concat(string(&apos;Bibliography List &apos;), ./topicmeta/navtitle, @navtitle[not(parent::*/topicmeta/navtitle)])'
            %ishlinkxpath-section-default;">

<!ENTITY % ish-glossarylist-atts
           "ishtype       CDATA #FIXED   'ISHSection'
            ishlabelxpath CDATA #FIXED   'concat(string(&apos;Glossary List &apos;), ./topicmeta/navtitle, @navtitle[not(parent::*/topicmeta/navtitle)])'
            %ishlinkxpath-section-default;">

<!ENTITY % ish-indexlist-atts
           "ishtype       CDATA #FIXED   'ISHSection'
            ishlabelxpath CDATA #FIXED   'concat(string(&apos;Index List &apos;), ./topicmeta/navtitle, @navtitle[not(parent::*/topicmeta/navtitle)])'
            %ishlinkxpath-section-default;">

<!ENTITY % ish-booklist-atts
           "ishtype       CDATA #FIXED   'ISHSection'
            ishlabelxpath CDATA #FIXED   'concat(string(&apos;Book List &apos;), ./topicmeta/navtitle, @navtitle[not(parent::*/topicmeta/navtitle)])'
            %ishlinkxpath-section-default;">
