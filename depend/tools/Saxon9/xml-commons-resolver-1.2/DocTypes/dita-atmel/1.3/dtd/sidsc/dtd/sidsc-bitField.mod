...
<!ENTITY % bitField-info-types
              "reference"
>
<!ENTITY % bit.dataPhrase.cnt
              "#PCDATA |
               %text; |
               ph"
>
...
<!ATTLIST  bitFieldValueGroup %global-atts;  class CDATA "- topic/strow dataTableDomain/dataRow sidsc-bitField/bitFieldValueGroup ">
